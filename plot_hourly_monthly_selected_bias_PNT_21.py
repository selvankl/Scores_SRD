...
tme_end = 18 ###---Limit the time to day by considering the solar zenith angle
...
if __name__ == "__main__":
	...
	month_n = [1, 2, 3, 4, 5, 6, 9] #--Available months from datasets 
	...
	for k_i in range(tme_len):
		...
		for mni in month_n:
			mon_ids = np.where(pd.DataFrame(index=date_lh_ki).index.month == mni)[0]; #qfkjkqjfkjf
